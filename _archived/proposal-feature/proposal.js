// Proposal generation using PptxGenJS
...
export async function generateProposal(research, meetingTitle) {
  ...
  const companyDomain = research.contacts?.[0]?.email?.split('@')[1] || '';
  const totalSlides = 9;
  ...
  slide1.addText('BISNOW', {
    ...
    fontSize: 28, bold: true, color: COLORS.orange,
  ...
  slide2.addText('About Bisnow', {
    ...
    fontSize: 32, bold: true, color: COLORS.charcoal,
    fontFace: 'Arial Black',
  });
  ...
  const bisnowStats = [
    ['436', 'Events Annually'],
    ['50+', 'Markets'],
    ['1.7M', 'Newsletter Subscribers'],
    ['11M', 'Annual Website Readers'],
    ['100K+', 'Event Attendees'],
    ['79', 'Email Newsletters'],
  ];
  ...
  attendeeStats.forEach((s, i) => {
    ...
    slide3.addShape(pptx.ShapeType.rect, {
      x, y: 1.3, w: 2.8, h: 1.4,
      fill: { color: COLORS.charcoal }, rectRadius: 0.1,
    });
    ...
    slide3.addText(s.label, {
      ...
      fontFace: 'Arial', align: 'center', wrap: true,
    });
  });
  ...
  if (research.target_audience?.pitch_rationale) {
    slide3.addShape(pptx.ShapeType.rect, {
      ...
      fill: { color: 'FFF3E8' }, rectRadius: 0.1,
  ...
  slide3.addText('$4T+ AUM represented  |  2B+ SF under ownership/management', {
    x: 0.5, y: 4.6, w: 9, h: 0.3,
    fontSize: 11, color: '888888', fontFace: 'Arial', align: 'center',
  });
  ...
  events.forEach((evt, i) => {
    ...
    slide4.addShape(pptx.ShapeType.rect, {
      ...
      fill: { color: COLORS.orange }, rectRadius: 0.25,
    });
  ...
  testimonials.forEach((t, i) => {
    ...
    slide8.addShape(pptx.ShapeType.rect, {
      x: 0.8, y, w: 8.4, h: 0.9,
      fill: { color: '222240' }, rectRadius: 0.08,
    });
    slide8.addText(t, {
      x: 1.0, y: y + 0.05, w: 8, h: 0.8,
      fontSize: 13, italic: true, color: COLORS.white,
  ...
  slide9.addText(`Let's discuss how to maximize your\nvisibility at ${bestEvent}`, {
    ...
    fontFace: 'Arial', align: 'center', lineSpacingMultiple: 1.5,
  });
  slide9.addShape(pptx.ShapeType.rect, {
    x: 2, y: 2.8, w: 6, h: 2,
    fill: { color: COLORS.white }, rectRadius: 0.1,
  ...
  slide9.addText('Jordan Hinsch', {
    ...
    fontSize: 20, bold: true, color: COLORS.charcoal,
    fontFace: 'Arial', align: 'center',
  });
